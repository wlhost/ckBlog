...
@section('title', $article['title'] . ' ' . $config['connection'] . ' ' . $config['sitename2'])
...
@section('main')
    <div class="eskimo-page-title">
        ...
        <div class="eskimo-page-title-meta">
            ...
            <div class="eskimo-author-meta">
                By <a class="author-meta" >{{$article['author']}}</a>
            </div>

            <div class="eskimo-date-meta">{{$article['created_at']}}</div>
            <div class="eskimo-reading-meta">{{$article['click']}} read</div>
        </div>
    </div>
    <!-- POST CONTENT -->
    <div class="eskimo-page-content">
        ...
        <div class="eskimo-meta-tags">
            @foreach($tag as $v)
                <span class="badge badge-default"><a href="category.html">{{ $v->name }}</a></span>
            @endforeach
        </div>
        ...
        <div id="eskimo-share-buttons" class="eskimo-share-buttons">
            <ul class="rrssb-buttons">
                ...
                <li class="rrssb-facebook">
                    <a href="https://www.facebook.com/sharer/sharer.php?u=https://eskimo.egemenerd.com/html/single-post.html" class="popup">
                                    <span class="rrssb-icon">
                ...
                <li class="rrssb-twitter">
                    <a href="https://twitter.com/intent/tweet?text=https://eskimo.egemenerd.com/html/single-post.html" class="popup">
                                    <span class="rrssb-icon">
                ...
                <li class="rrssb-linkedin">
                    <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://eskimo.egemenerd.com/html/single-post.html" class="popup">
                                    <span class="rrssb-icon">
                ...
                <li class="rrssb-tumblr">
                    <a href="https://tumblr.com/share/link?url=https://eskimo.egemenerd.com/html/single-post.html&amp;name=Title%20Here">
                                    <span class="rrssb-icon">
                ...
                <!-- VK -->
                <li class="rrssb-vk">
                    <a href="https://vk.com/share.php?url=https://eskimo.egemenerd.com/html/single-post.html" class="popup">
                                    <span class="rrssb-icon">
                ...
                <li class="rrssb-googleplus">
                    <a href="https://plus.google.com/share?url=https://eskimo.egemenerd.com/html/single-post.html" class="popup">
                                    <span class="rrssb-icon">
                ...
                <li class="rrssb-pinterest">
                    <a href="https://pinterest.com/pin/create/button/?url=https://eskimo.egemenerd.com/html/single-post.html&amp;media=https://eskimo.egemenerd.com/wp-content/uploads/2018/05/blog19.jpg&amp;description=Description%20Here" class="popup">
                                    <span class="rrssb-icon">
        ...
        <div class="eskimo-post-nav-wrapper">
            ...
            <div class="eskimo-post-nav-left-row">
                <div class="eskimo-post-nav-table">
                    ...
                    <div class="eskimo-post-nav-link">
                        <a class="eskimo-post-nav" href="/article/{{ $prev['id'] }}">{{ $prev['title'] }}</a>
                    </div>
                </div>
            </div>
            <!-- NEXT POST -->
            <div class="eskimo-post-nav-right-row">
                <div class="eskimo-post-nav-table">
                    <div class="eskimo-post-nav-link">
                        <a class="eskimo-post-nav" href="/article/{{ $next['id'] }}">{{ $next['title'] }}</a>
                    </div>
                    <a class="eskimo-post-nav" href="single-post.html">
                        ...
                        {{--<div class="eskimo_comment">--}}
                            {{--<div class="eskimo_comment_inner">--}}
                                {{--<div class="eskimo_comment_left">--}}
                                    {{--<img alt='' src='https://0.gravatar.com/avatar/0b19666d0fc7a149e6f8f2319a04ef63?s=60&#038;d=mm&#038;r=g' />--}}
                                {{--</div>--}}
